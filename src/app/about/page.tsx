        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted leading-relaxed">
              We are the leading Manufacturer and supplier for Electronic
              Digital Tyre Inflator all over India since the year 2007. Our
              Electronic Digital Tyre Inflator is reliable, durable and
              accurate, thus meeting the requirement of each and every horizon
              related to vehicle tyre pressure inflation.
            </p>
            <p className="text-lg text-muted leading-relaxed">
              Our Inflators are used by major tyre manufacturers as well as
              vehicle manufacturers in their production line up. Our Electronic
              Digital Tyre Inflator meets the accuracy suggested by tyre
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="bg-white p-8 rounded-[30px] shadow-sm border border-gray-100">
            ...
            <p className="text-muted">
              Our control panel Enclosure meets the Ingress Protection standard
              IP65, ensuring durability and reliability in all conditions.
            </p>
          </div>
          <div className="bg-white p-8 rounded-[30px] shadow-sm border border-gray-100">
            <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-6">
            ...
            <p className="text-muted">
              We continuously innovate our product line, from Digital Nitrogen
              Tyre Inflators to advanced Automation Panels.
            </p>
          </div>
          <div className="bg-white p-8 rounded-[30px] shadow-sm border border-gray-100">
            <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-6">
            ...
            <p className="text-muted">
              Trusted by major companies like IOCL, BPCL, HPCL, MRF, Michelin,
