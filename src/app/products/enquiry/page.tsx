        ...
        <div className="bg-white rounded-[40px] shadow-lg p-8 sm:p-12 lg:p-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Compact and portable digital tyre inflator with LED display
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-4">
                <button
                  ...
                  className="w-full px-8 py-4 bg-accent text-white font-medium rounded-full hover:bg-accent-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
